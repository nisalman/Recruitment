...
@section('content')
    <form method="post" class="se-form" data-name="sports-setup">
        ...
        <div class="form-group">
            <div class="title">ক্লাব নিবন্ধন</div>

            <div class="col-md-4">
                <label for="">ক্লাবের নাম</label>
                <input type="text" name="name" class="form-control bn" required="">
            </div>

            <div class="col-md-4">
                <label for="">ক্লাবের ঠিকানা </label>
                <input type="text" name="address" class="form-control bn" required="">
            </div>

            <div class="col-md-2">
                <label for="">স্থাপিত</label>
                <select name="established" id="" class="form-control" required="">
                    <option value="">--</option>
                    @foreach(App\Sport::established() as $yearEn => $yearBn)
                        <option value="{{$yearEn}}">{{$yearBn}}</option>
                    @endforeach
                </select>
            </div>
        ...
        $(function () {
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'established', name: 'established'},
