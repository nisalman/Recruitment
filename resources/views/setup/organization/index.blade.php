...
@section('content')
    <div class="container-narrow">
        <button id="btn-add" name="btn-add" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class='fa fa-plus'></i> সংস্থা নিবন্ধন</button>
        <div>
            @include('setup.organization.form')
        </div>
        <div class="list-container">
            @include('setup.organization.list')
        </div>
    </div>
    <script>
