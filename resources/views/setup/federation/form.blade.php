        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="sportsModalArea"> ফেডারেশন নিবন্ধন</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name">ফেডারেশনের নাম</label>
                        <input type="text" name="name" id="name" class="form-control bn" required="">
                        <input type="hidden" name="federation_id" id="federation_id" value="0">
                    </div>
                    <div class="form-group">
