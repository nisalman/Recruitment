...
@section('content')
    <div class="container-narrow">
        <button id="btn-add" name="btn-add" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class='fa fa-plus'></i> Job Setup</button>
        <div>
            @include('setup.jobs.form')
        </div>
        <div class="list-container">
            @include('setup.jobs.list')
        </div>
    </div>
    <script>
